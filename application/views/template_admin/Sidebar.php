  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="active">
            <a href="<?= base_url('admin/Dashboard_admin')?>">
              <i class="nc-icon nc-bank"></i>
              <p>Dashboard</p>
            </a>
          </li>
          <li>
            <a href="<?= base_url('admin/Layanan_admin')?>">
              <i class="nc-icon nc-tile-56"></i>
              <p>Data Layanan</p>
            </a>
          </li>
          <li>
            <a href="<?= base_url('admin/Produk_admin')?>">
              <i class="nc-icon nc-shop"></i>
              <p>Data Produk</p>
            </a>
          </li>
          <li>
            <a href="<?= base_url('admin/Invoice_admin')?>">
              <i class="nc-icon nc-paper"></i>
              <p>Data Invoice</p>
            </a>
          </li>
          <li>
            <a href="<?= base_url('admin/Pembayaran_admin')?>">
              <i class="nc-icon nc-money-coins"></i>
              <p>Data Pembayaran</p>
            </a>
          </li>
          <li>
            <a href="<?= base_url('admin/Customer_admin/customer')?>">
              <i class="nc-icon nc-single-02"></i>
              <p>Data Customer</p>
            </a>
          </li>
          <li>
            <a href="<?= base_url('admin/Penjahit_admin/penjahit')?>">
              <i class="nc-icon nc-single-02"></i>
              <p>Data Penjahit</p>
            </a>
          </li>
          ...
          <li>
            <a href="<?= base_url('admin/Penilaian_admin')?>">
